...
class PersetujuanplpasalkmsController extends AbstractActionController
{
    protected $sTable;
    ...
    public function detailAction()
    {
		...
		$view = new ViewModel(array('sForm' 	=> 'form',
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 array('url' => '/penerimaan/persetujuanplpasal', 'name' => 'Respon PLP TPS Asal', 'active' => ''),
														 array('url' => '/penerimaan/persetujuanplpasalkms', 'name' => 'Respon PLP TPS Asal Kemasan 
...
', 'active' => ''),
    ...
    public function getTable()
    {
        if (!$this->sTable) {
            ...
            $this->sTable = $sm->get('Penerimaan\Persetujuanplp\Model\PersetujuanplpasalkmsTable');
        }
        return $this->sTable;
    }
