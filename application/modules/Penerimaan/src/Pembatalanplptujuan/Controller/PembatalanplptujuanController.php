...
namespace Penerimaan\Pembatalanplptujuan\Controller;

use Zend\Mvc\Controller\AbstractActionController;
use Zend\View\Model\ViewModel;
use SoapClientWsdl;
	
class PembatalanplptujuanController extends AbstractActionController
{
    protected $sTable;
	...
	public function mainAction()
    {
		...
		$view = new ViewModel(array('sForm' 	=> 'form',
									...
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 array('url' => '', 'name' => 'Pembatalan PLP TPS Tujuan', 'active' => 'active')
														),
    ...
    public function listAction()
    {
		...
		$view = new ViewModel(array('sForm' 	=> 'form',
									...
									'sMenuAct' 	=> 'Permohonanplp',
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 array('url' => '/penerimaan/pembatalanplptujuan', 'name' => 'Pembatalan PLP TPS Tujuan', 'active' => ''),
														 array('url' => '', 'name' => 'Pembatalan PLP TPS Tujuan Peti Kemas', 'active' => 'active')
														),
									'userinfo' 	=> $this->getUserInfo(),
									)
							 );
    ...
    public function detailAction()
    {
		...
		$view = new ViewModel(array('sForm' 	=> 'form',
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 array('url' => '/penerimaan/pembatalanplptujuan', 'name' => 'Pembatalan PLP TPS Tujuan', 'active' => ''),
														 array('url' => '/penerimaan/pembatalanplptujuan/list', 'name' => 'Pembatalan PLP TPS Tujuan Peti Kemas 
...
', 'active' => ''),
    ...
    public function getTable()
    {
        if (!$this->sTable) {
            ...
            $this->sTable = $sm->get('Penerimaan\Pembatalanplptujuan\Model\PembatalanplptujuanTable');
        }
        return $this->sTable;
    }
