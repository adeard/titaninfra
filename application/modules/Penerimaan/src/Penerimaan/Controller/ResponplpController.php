...
class ResponplpController extends AbstractActionController
{
    protected $sTable;
	...
	public function listAction()
    {
		...
		/**	ROLE ACCESS VIEW */
		if(!$this->getPrivilege()->check($this->getUserInfo()->IDUSER,  ACCESS_MODULE_2_RESPONPLP, VIEW))
		...
		$view = new ViewModel(array('sForm' 	=> 'table',
									...
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 array('url' => '', 'name' => 'Respon PLP', 'active' => 'active')
														),
    ...
    public function detailAction()
    {
		...
		/**	ROLE ACCESS EDIT */
		if(!$this->getPrivilege()->check($this->getUserInfo()->IDUSER,  ACCESS_MODULE_2_RESPONPLP, EDIT))
			$this->getPrivilege()->forbidden();
		...
		$view = new ViewModel(array('sForm' 	=> 'form',
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 array('url' => '/penerimaan/responplp', 'name' => 'Respon PLP', 'active' => ''),
    ...
    public function deleteAction()
    {
		...
		/**	ROLE ACCESS DELETE */
		if(!$this->getPrivilege()->check($this->getUserInfo()->IDUSER,  ACCESS_MODULE_2_RESPONPLP, DELETE))
			$this->getPrivilege()->forbidden();
	...
	public function jsonAction() 
	{
		...
		$data['ISTERIMA'] 		= $this->request->getQuery('ISTERIMA');
    ...
    public function getTable()
    {
        if (!$this->sTable) {
            ...
            $this->sTable = $sm->get('Penerimaan\Model\ResponplpTable');
        }
        return $this->sTable;
    }
