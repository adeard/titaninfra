...
class PersetujuanplptujuankmsdetailController extends AbstractActionController
{
    protected $sTable;
    ...
    public function getTable()
    {
        if (!$this->sTable) {
            ...
            $this->sTable = $sm->get('Penerimaan\Persetujuanplptujuan\Model\PersetujuanplptujuankmsdetailTable');
        }
        return $this->sTable;
    }
