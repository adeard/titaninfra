...
class PembatalanplpasalController extends AbstractActionController
{
    protected $sTable;
	...
	public function mainAction()
    {
		...
		$view = new ViewModel(array('sForm' 	=> 'form',
									...
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 array('url' => '', 'name' => 'Pembatalan PLP TPS Asal', 'active' => 'active')
														),
    ...
    public function listAction()
    {
		...
		$view = new ViewModel(array('sForm' 	=> 'form',
									...
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 ...
														 array('url' => '', 'name' => 'Pembatalan PLP TPS Asal Peti Kemas', 'active' => 'active')
														),
									'userinfo' 	=> $this->getUserInfo(),
									)
							 );
	...
	public function detailAction()
    {
		...
		$view = new ViewModel(array('sForm' 	=> 'form',
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 array('url' => '/penerimaan/pembatalanplpasal', 'name' => 'Pembatalan PLP TPS Asal', 'active' => ''),
														 array('url' => '/penerimaan/pembatalanplpasal/list', 'name' => 'Pembatalan PLP TPS Asal Peti Kemas 
...
', 'active' => ''),
    ...
    public function getTable()
    {
        if (!$this->sTable) {
            ...
            $this->sTable = $sm->get('Penerimaan\Pembatalanplp\Model\PembatalanplpasalTable');
        }
        return $this->sTable;
    }
