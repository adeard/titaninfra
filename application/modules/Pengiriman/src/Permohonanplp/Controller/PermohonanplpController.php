...
class PermohonanplpController extends AbstractActionController
{
    protected $sTable;
	...
	public function mainAction()
    {
		...
		$view = new ViewModel(array('sForm' 	=> 'form',
									...
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 array('url' => '', 'name' => 'Permohonan PLP', 'active' => 'active')
														),
...
', 'active' => ''),
    ...
    public function getTable()
    {
        if (!$this->sTable) {
            ...
            $this->sTable = $sm->get('Pengiriman\Permohonanplp\Model\PermohonanplpTable');
        }
        return $this->sTable;
    }
