...
class PermohonanplpdetailController extends AbstractActionController
{
    protected $sTable;
    ...
    public function listAction()
    {
		...
		$view = new ViewModel(array('sForm' 	=> 'form',
									...
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 ...
														 array('url' => '', 'name' => 'Permohonan PLP Peti Kemas', 'active' => 'active')
														),
	...
	public function addAction()
    {
		...
		$PermohonanplpTable = $this->getServiceLocator()->get('Pengiriman\Permohonanplp\Model\PermohonanplpTable');
		...
		$view = new ViewModel(array('sForm' 	=> 'form',
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 array('url' => '/pengiriman/permohonanplp', 'name' => 'Permohonan PLP', 'active' => ''),
														 array('url' => '/pengiriman/permohonanplp/list', 'name' => 'Permohonan PLP Peti Kemas 

', 'active' => ''),
														 array('url' => '/pengiriman/permohonanplp/edit/'.$desc['ID_PLP'], 'name' => 'Detail 
...
', 'active' => ''),
    ...
    public function getTable()
    {
        if (!$this->sTable) {
            ...
            $this->sTable = $sm->get('Pengiriman\Permohonanplp\Model\PermohonanplpdetailTable');
        }
        return $this->sTable;
    }
