...
class TangkidetailController extends AbstractActionController
{
    protected $sTable;
	...
	public function addAction()
    {
		...
		$TangkiTable = $this->getServiceLocator()->get('Pengiriman\Tangki\Model\TangkiTable');
		
		$desc = $TangkiTable->getData($data);
		
		$view = new ViewModel(array('sForm' 	=> 'form',
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 array('url' => '/pengiriman/tangki', 'name' => 'Coarri-Codeco Tangki', 'active' => ''),
														 array('url' => '/pengiriman/tangki/edit/'.$desc['ID_COARRICODECO'], 'name' => 'Detail', 'active' => ''),
    ...
    public function getTable()
    {
        if (!$this->sTable) {
            ...
            $this->sTable = $sm->get('Pengiriman\Tangki\Model\TangkidetailTable');
        }
        return $this->sTable;
    }
