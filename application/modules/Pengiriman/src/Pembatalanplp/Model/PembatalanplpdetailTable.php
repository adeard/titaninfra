...
class PembatalanplpdetailTable extends AbstractTableGateway
{
    protected $table;
	protected $adapter;
	public $connection;
	...
	public function fetchAll($param)
    {
		...
		foreach($data as $entry) {
			...
			*/
			$action	= '	<a data-href="'.BASEPATH.'/pengiriman/pembatalanplpdetail/edit/'.$entry['ID_DET_PLP'].'" rel="tooltip" title="Edit" class="ajaxify">
							<button class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></button>
						</a> 
						
                       	<a data-href="'.BASEPATH.'/pengiriman/pembatalanplpdetail/delete/'.$entry['ID_DET_PLP'].'" rel="tooltip" title="Delete" class="delete">
							<button class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></button> 
						</a>';
	   		
			$row[]	= array('<input type="checkbox" name="UID[]" id="UID" value="'.$entry['ID_DET_PLP'].'" class="checkboxes">',
							$entry['ID_DET_PLP'],
							'<a data-href="'.BASEPATH.'/pengiriman/pembatalanplpdetail/edit/'.$entry['ID_DET_PLP'].'" rel="tooltip" title="Edit" class="ajaxify">'.$entry['NO_CONT'].'</a>',
							$entry['UK_CONT'],
							$action
							);
			$number++;
