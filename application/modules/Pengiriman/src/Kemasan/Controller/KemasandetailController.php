...
namespace Pengiriman\Kemasan\Controller;

use Zend\Mvc\Controller\AbstractActionController;
use Zend\View\Model\ViewModel;
	
class KemasandetailController extends AbstractActionController
{
    protected $sTable;
    ...
    public function listAction()
    {
		...
		/**	ROLE ACCESS VIEW */
		if(!$this->getPrivilege()->check($this->getUserInfo()->IDUSER,  ACCESS_MODULE_3_KEMASAN, VIEW))
		...
		$view = new ViewModel(array('sForm' 	=> 'form',
									...
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 array('url' => '/pengiriman/kemasan', 'name' => 'Coarri-Codeco Kemasan', 'active' => ''),
	...
	public function addAction()
    {
		...
		$KemasanTable = $this->getServiceLocator()->get('Pengiriman\Kemasan\Model\KemasanTable');
		
		$desc = $KemasanTable->getData($data);
		
		$view = new ViewModel(array('sForm' 	=> 'form',
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 array('url' => '/pengiriman/kemasan', 'name' => 'Coarri-Codeco Kemasan', 'active' => ''),
														 array('url' => '/pengiriman/kemasan/edit/'.$desc['ID_COARRICODECO'], 'name' => 'Detail', 'active' => ''),
    ...
    public function editAction()
    {
		...
		/**	ROLE ACCESS EDIT */
		if(!$this->getPrivilege()->check($this->getUserInfo()->IDUSER,  ACCESS_MODULE_3_KEMASAN, EDIT))
			$this->getPrivilege()->forbidden();
    ...
    public function deleteAction()
    {
		...
		/**	ROLE ACCESS DELETE */
		if(!$this->getPrivilege()->check($this->getUserInfo()->IDUSER,  ACCESS_MODULE_3_KEMASAN, DELETE))
			$this->getPrivilege()->forbidden();
    ...
    public function getTable()
    {
        if (!$this->sTable) {
            ...
            $this->sTable = $sm->get('Pengiriman\Kemasan\Model\KemasandetailTable');
        }
        return $this->sTable;
    }
