...
class KemasanController extends AbstractActionController
{
    protected $sTable;
    ...
    public function listAction()
    {
		...
		$view = new ViewModel(array('sForm' 	=> 'form',
									...
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 array('url' => '', 'name' => 'Coarri-Codeco Kemasan', 'active' => 'active')
														),
    ...
    public function getTable()
    {
        if (!$this->sTable) {
            ...
            $this->sTable = $sm->get('Pengiriman\Kemasan\Model\KemasanTable');
        }
        return $this->sTable;
    }
