	...
	$(function() {
		{/literal}
			...
			{section name=module loop=$module}
				{math assign="cols" equation="x-1" x=$smarty.section.module.iteration}
				{if $descRole[$cols]['IDMODUL'] == $module[module].IDMODUL AND $descRole[$cols]['ROLEVIEW'] == 1}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" 
                                   ...
                                   data-rule-remote="{$this->basePath()}/admin/group/check?CURRENTNAMAGROUP={$desc['NAMAGROUP']}"
                                   data-msg-remote="Nama group sudah terpakai"
                                   
                                   value="{$desc['NAMAGROUP']}"
                                   class="form-control">
                        </div>
                    </div>
