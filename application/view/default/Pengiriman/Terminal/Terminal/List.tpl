		...
		<div class="portlet box green-haze">
			...
			<div class="portlet-body form">
				<div class="form-body">
					...
					<form 	action="{$this->basePath()}/pengiriman/terminal/search" 
							method="post" 
			...
			<div class="portlet-body form util-btn-margin-bottom-5" style="margin-bottom: -15px">
				<form 	action="{$this->basePath()}/pengiriman/terminal/send" 
						method="post" 
				...
				<div class="form-body">
					...
					<div class="clearfix">
						<a data-href="{$this->basePath()}/pengiriman/terminal/add" class="btn btn-circle blue ajaxify">
