...
jQuery(document).ready(function() {	
	...
	var oPermohonanplpdetailTable 	= permohonanplpdetailTable.dataTable({
		...
		"bFilter": false,
		"ajax": {
			"url": base_url+"pengiriman/permohonanplpdetail/json?ID_PLP="+ID_PLP,
		},
		"columns": [
		...
		"fnRowCallback": function (nRow, aaData, iDisplayIndex, iDisplayIndexFull) {
			$(nRow).dblclick(function() {
				$(nRow).attr({"data-href":base_url+"pengiriman/permohonanplppos/edit/"+aaData[1], "class":"ajaxify"}).click();
			});
			return nRow;
		},
...
<!-- BEGIN PAGE CONTENT-->
<form 	action="{$this->basePath()}/pengiriman/permohonanplp/save" 
    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue-madison">
            <div class="portlet-title">
                ...
                <div class="actions">
                	<a data-href="{$this->basePath()}/pengiriman/permohonanplp/list" class="btn btn-default btn-sm ajaxify">
                    ...
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            ...
                            <input type="hidden" name="REF_NUMBER" id="REF_NUMBER" 
                           	...
                           	<a data-href="{$this->basePath()}/pengiriman/permohonanplp/list" class="btn default ajaxify">
                            	<i class="fa fa-arrow-left"></i> Kembali 
                            </a>
	...
	<div class="col-md-12">
		...
		<div class="portlet box purple">
			...
			<div class="portlet-body form util-btn-margin-bottom-5" style="margin-bottom: -15px">
				<div class="form-body">
					<div class="clearfix">
						<a data-href="{$this->basePath()}/pengiriman/permohonanplpdetail/add?ID_PLP={$desc['ID_PLP']}" class="btn btn-circle purple ajaxify">
