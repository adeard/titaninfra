...
<!-- BEGIN PAGE CONTENT-->
<form 	action="{$this->basePath()}/pengiriman/pembatalanplpdetail/save" 
    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue-madison">
            <div class="portlet-title">
                ...
                <div class="actions">
                	<a data-href="{$this->basePath()}/pengiriman/pembatalanplp/edit/{$desc['ID_PLP']}" class="btn btn-default btn-sm ajaxify">
                    ...
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            ...
                            <input type="hidden" 
                           	...
                           	<a data-href="{$this->basePath()}/pengiriman/pembatalanplp/edit/{$desc['ID_PLP']}" class="btn default ajaxify">
                            	<i class="fa fa-arrow-left"></i> Kembali 
                            </a>	   
