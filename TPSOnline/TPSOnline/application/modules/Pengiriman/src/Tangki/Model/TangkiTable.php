...
class TangkiTable extends AbstractTableGateway
{
    protected $table;
	protected $adapter;
	public $connection;
	...
	public function fetchAll($param)
    {
		...
		foreach($data as $entry) {
			...
			*/
			$action	= '	<a data-href="'.BASEPATH.'/pengiriman/tangki/edit/'.$entry['ID_COARRICODECO'].'" rel="tooltip" title="Edit" class="ajaxify">
							<button class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></button>
						</a> 
						
                       	<a data-href="'.BASEPATH.'/pengiriman/tangki/delete/'.$entry['ID_COARRICODECO'].'" rel="tooltip" title="Delete" class="delete">
