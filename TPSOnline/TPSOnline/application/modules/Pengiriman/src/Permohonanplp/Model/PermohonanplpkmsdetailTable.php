...
class PermohonanplpkmsdetailTable extends AbstractTableGateway
{
    protected $table;
	protected $adapter;
	public $connection;
	...
	public function fetchAll($param)
    {
		...
		foreach($data as $entry) {
			...
			*/
			$action	= '	<a data-href="'.BASEPATH.'/pengiriman/permohonanplpkmsdetail/edit/'.$entry['ID_DET_PLP'].'" rel="tooltip" title="Edit" class="ajaxify">
							<button class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></button>
						</a> 
						
                       	<a data-href="'.BASEPATH.'/pengiriman/permohonanplpkmsdetail/delete/'.$entry['ID_DET_PLP'].'" rel="tooltip" title="Delete" class="delete">
							<button class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></button> 
						</a>';
			
			$row[]	= array('<input type="checkbox" name="UID[]" id="UID" value="'.$entry['ID_DET_PLP'].'" class="checkboxes">',
							$entry['ID_DET_PLP'],
							'<a data-href="'.BASEPATH.'/pengiriman/permohonanplpkmsdetail/edit/'.$entry['ID_DET_PLP'].'" rel="tooltip" title="Edit" class="ajaxify">'.$entry['JNS_KMS'].'</a>',
							$entry['JML_KMS'],
							$entry['NO_BL_AWB'],
							$entry['TGL_BL_AWB'],
							$action
