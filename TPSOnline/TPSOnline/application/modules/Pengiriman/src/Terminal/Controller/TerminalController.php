...
class TerminalController extends AbstractActionController
{
    ...
    public function listAction()
    {
		...
		$view = new ViewModel(array('sForm' 	=> 'form',
									...
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 array('url' => '', 'name' => 'Coarri-Codeco Car Terminal', 'active' => 'active')
														),
    ...
    public function editAction()
    {
		...
		$view = new ViewModel(array('sForm' 	=> 'form',
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 array('url' => '/pengiriman/container', 'name' => 'Coarri-Codeco Car Terminal', 'active' => ''),
    ...
    public function getTable()
    {
        if (!$this->sTable) {
            ...
            $this->sTable = $sm->get('Pengiriman\Terminal\Model\TerminalTable');
        }
        return $this->sTable;
    }
