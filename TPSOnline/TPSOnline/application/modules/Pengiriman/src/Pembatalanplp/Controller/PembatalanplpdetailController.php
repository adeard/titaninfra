...
class PembatalanplpdetailController extends AbstractActionController
{
    protected $sTable;
    ...
    public function listAction()
    {
		...
		$view = new ViewModel(array('sForm' 	=> 'form',
									...
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 ...
														 array('url' => '', 'name' => 'Pembatalan PLP Peti Kemas', 'active' => 'active')
														),
	...
	public function addAction()
    {
		...
		$PembatalanplpTable = $this->getServiceLocator()->get('Pengiriman\Pembatalanplp\Model\PembatalanplpTable');
		...
		$view = new ViewModel(array('sForm' 	=> 'form',
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 array('url' => '/pengiriman/pembatalanplp', 'name' => 'Pembatalan PLP', 'active' => ''),
														 array('url' => '/pengiriman/pembatalanplp/list', 'name' => 'Pembatalan PLP Peti Kemas 

', 'active' => ''),
														 array('url' => '/pengiriman/pembatalanplp/edit/'.$desc['ID_PLP'], 'name' => 'Detail 
...
', 'active' => ''),
    ...
    public function getTable()
    {
        if (!$this->sTable) {
            ...
            $this->sTable = $sm->get('Pengiriman\Pembatalanplp\Model\PembatalanplpdetailTable');
        }
        return $this->sTable;
    }
