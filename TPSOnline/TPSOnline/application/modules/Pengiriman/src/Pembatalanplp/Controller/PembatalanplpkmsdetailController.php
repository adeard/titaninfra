...
namespace Pengiriman\Pembatalanplp\Controller;

use Zend\Mvc\Controller\AbstractActionController;
use Zend\View\Model\ViewModel;
	
class PembatalanplpkmsdetailController extends AbstractActionController
{
    protected $sTable;
    ...
    public function listAction()
    {
		...
		$view = new ViewModel(array('sForm' 	=> 'form',
									...
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 array('url' => '/pengiriman/pembatalanplp', 'name' => 'Pembatalan PLP', 'active' => ''),
														 array('url' => '', 'name' => 'Pembatalan PLP Kemasan', 'active' => 'active')
														),
	...
	public function addAction()
    {
		...
		$PembatalanplpTable = $this->getServiceLocator()->get('Pengiriman\Pembatalanplp\Model\PembatalanplpkmsTable');
		
		$desc = $PembatalanplpTable->getData($data);
		
		$view = new ViewModel(array('sForm' 	=> 'form',
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 array('url' => '/pengiriman/pembatalanplp', 'name' => 'Pembatalan PLP', 'active' => ''),
														 array('url' => '/pengiriman/pembatalanplpkms', 'name' => 'Pembatalan PLP Kemasan

', 'active' => ''),
														 array('url' => '/pengiriman/pembatalanplpkms/edit/'.$desc['ID_PLP'], 'name' => 'Detail 
...
', 'active' => ''),
    ...
    public function getTable()
    {
        if (!$this->sTable) {
            ...
            $this->sTable = $sm->get('Pengiriman\Pembatalanplp\Model\PembatalanplpkmsdetailTable');
        }
        return $this->sTable;
    }
