...
class PersetujuanplpasaldetailController extends AbstractActionController
{
    protected $sTable;
    ...
    public function getTable()
    {
        if (!$this->sTable) {
            ...
            $this->sTable = $sm->get('Penerimaan\Persetujuanplp\Model\PersetujuanplpasaldetailTable');
        }
        return $this->sTable;
    }
