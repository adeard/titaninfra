...
class PersetujuanplpasalkmsdetailTable extends AbstractTableGateway
{
    protected $table;
	protected $adapter;
	public $connection;
	...
	public function fetchAll($param)
    {
		...
		foreach($data as $entry) {
			...
			*/
			$action	= '	<a data-href="'.BASEPATH.'/penerimaan/persetujuanplpasalkmsdetail/edit/'.$entry['ID_DET_RESPONPLP'].'" rel="tooltip" title="Edit" class="ajaxify">
							<button class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></button>
						</a> 
						
                       	<a data-href="'.BASEPATH.'/penerimaan/persetujuanplpasalkmsdetail/delete/'.$entry['ID_DET_RESPONPLP'].'" rel="tooltip" title="Delete" class="delete">
