...
class PembatalanplptujuankmsController extends AbstractActionController
{
    protected $sTable;
    ...
    public function listAction()
    {
		...
		$view = new ViewModel(array('sForm' 	=> 'form',
									...
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 ...
														 array('url' => '', 'name' => 'Pembatalan PLP TPS Tujuan Kemasan', 'active' => 'active')
														),
    ...
    public function detailAction()
    {
		...
		$view = new ViewModel(array('sForm' 	=> 'form',
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 array('url' => '/penerimaan/pembatalanplptujuan', 'name' => 'Pembatalan PLP TPS Tujuan', 'active' => ''),
														 array('url' => '/penerimaan/Pembatalanplptujuankms', 'name' => 'Pembatalan PLP TPS Tujuan Kemasan 
...
', 'active' => ''),
    ...
    public function getTable()
    {
        if (!$this->sTable) {
            ...
            $this->sTable = $sm->get('Penerimaan\Pembatalanplptujuan\Model\PembatalanplptujuankmsTable');
        }
        return $this->sTable;
    }
