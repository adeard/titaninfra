...
class PembatalanplptujuandetailController extends AbstractActionController
{
    protected $sTable;
    ...
    public function getTable()
    {
        if (!$this->sTable) {
            ...
            $this->sTable = $sm->get('Penerimaan\Pembatalanplptujuan\Model\PembatalanplptujuandetailTable');
        }
        return $this->sTable;
    }
