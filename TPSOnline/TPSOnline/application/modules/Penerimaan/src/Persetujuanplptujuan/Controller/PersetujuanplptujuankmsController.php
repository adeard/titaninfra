...
class PersetujuanplptujuankmsController extends AbstractActionController
{
    protected $sTable;
    ...
    public function listAction()
    {
		...
		$view = new ViewModel(array('sForm' 	=> 'form',
									...
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 ...
														 array('url' => '', 'name' => 'Respon PLP TPS Tujuan Kemasan', 'active' => 'active')
														),
    ...
    public function detailAction()
    {
		...
		$view = new ViewModel(array('sForm' 	=> 'form',
									'dashMenu'	=> array(array('url' => '/main', 'name' => 'Home', 'active' => ''),
														 array('url' => '/penerimaan/persetujuanplptujuan', 'name' => 'Respon PLP TPS Tujuan', 'active' => ''),
														 array('url' => '/penerimaan/persetujuanplptujuankms', 'name' => 'Respon PLP TPS Tujuan Kemasan 
...
', 'active' => ''),
    ...
    public function getTable()
    {
        if (!$this->sTable) {
            ...
            $this->sTable = $sm->get('Penerimaan\Persetujuanplptujuan\Model\PersetujuanplptujuankmsTable');
        }
        return $this->sTable;
    }
