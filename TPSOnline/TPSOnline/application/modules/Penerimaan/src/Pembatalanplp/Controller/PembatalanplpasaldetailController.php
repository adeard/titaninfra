...
class PembatalanplpasaldetailController extends AbstractActionController
{
    protected $sTable;
    ...
    public function getTable()
    {
        if (!$this->sTable) {
            ...
            $this->sTable = $sm->get('Penerimaan\Pembatalanplp\Model\PembatalanplpasaldetailTable');
        }
        return $this->sTable;
    }
