...
class PembatalanplpasalkmsdetailController extends AbstractActionController
{
    protected $sTable;
    ...
    public function getTable()
    {
        if (!$this->sTable) {
            ...
            $this->sTable = $sm->get('Penerimaan\Pembatalanplp\Model\PembatalanplpasalkmsdetailTable');
        }
        return $this->sTable;
    }
