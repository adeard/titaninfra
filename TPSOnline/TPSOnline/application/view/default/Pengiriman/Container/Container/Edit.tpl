...
jQuery(document).ready(function() {	
	...
	var containerdetailTable		= $('#containerdetailTable');
	var oContainerdetailTable 		= containerdetailTable.dataTable({
		...
		"bFilter": false,
		"ajax": {
			"url": base_url+"pengiriman/containerdetail/json?ID_COARRICODECO="+ID_COARRICODECO,
		},
		"columns": [
		...
		"fnRowCallback": function (nRow, aaData, iDisplayIndex, iDisplayIndexFull) {
			$(nRow).dblclick(function() {
				$(nRow).attr({"data-href":base_url+"pengiriman/containerdetail/edit/"+aaData[1], "class":"ajaxify"}).click();
			});
			return nRow;
		},
	...
	<div class="col-md-12">
		...
		<div class="portlet box purple">
			...
			<div class="portlet-body form util-btn-margin-bottom-5" style="margin-bottom: -15px">
				<div class="form-body">
					<div class="clearfix">
						<a data-href="{$this->basePath()}/pengiriman/containerdetail/add?ID_COARRICODECO={$desc['ID_COARRICODECO']}" class="btn btn-circle purple ajaxify">
			...
			<div class="portlet-body">
				<div class="table-container">
					...
					<tr role="row" class="heading">
						...
						<th>PEL BONGKAR</th>
						<th>GUDANG TUJUAN</th>
						<th>KD KANTOR PABEAN</th>
						<th>NO DAFTAR PABEAN</th>
						<th>TGL DAFTAR PABEAN</th>
						<th>NO SEGEL BC</th>
						<th>TGL SEGEL BC</th>
						<th>NO DOK IJIN TPS</th>
						<th>TGL DOK IJIN TPS</th>
					</tr>
					</thead>
