...
jQuery(document).ready(function() {	
	...
	var oPermohonanplpkmsTable 	= permohonanplpkmsTable.dataTable({
		...
		"bDestroy": true,
		"ajax": {
			"url": base_url+"pengiriman/permohonanplpkms/json",
		},
		"columns": [
		...
		"fnRowCallback": function (nRow, aaData, iDisplayIndex, iDisplayIndexFull) {
			$(nRow).dblclick(function() {
				$(nRow).attr({"data-href":base_url+"pengiriman/permohonanplpkms/edit/"+aaData[1], "class":"ajaxify"}).click();
			});
			return nRow;
		},
	...
	<div class="col-md-12">
		...
		<div class="portlet box green-haze">
			<div class="portlet-title">
				...
				<div class="actions">
					<a data-href="{$this->basePath()}/pengiriman/permohonanplp" class="btn btn-default btn-sm ajaxify">
			...
			<div class="portlet-body form util-btn-margin-bottom-5" style="margin-bottom: -15px">
				<form 	action="{$this->basePath()}/pengiriman/permohonanplpkms/send" 
						method="post" 
						class="SendAll form-horizontal">
						
				<div class="form-body">
					<div class="clearfix">
						<a data-href="{$this->basePath()}/pengiriman/permohonanplpkms/add" class="btn btn-circle blue ajaxify">
