...
jQuery(document).ready(function() {	
	...
	var oPermohonanplpkmsdetailTable= permohonanplpkmsdetailTable.dataTable({
		...
		"bFilter": false,
		"ajax": {
			"url": base_url+"pengiriman/permohonanplpkmsdetail/json?ID_PLP="+ID_PLP,
		},
		"columns": [
		...
		"fnRowCallback": function (nRow, aaData, iDisplayIndex, iDisplayIndexFull) {
			$(nRow).dblclick(function() {
				$(nRow).attr({"data-href":base_url+"pengiriman/permohonanplpkmsdetail/edit/"+aaData[1], "class":"ajaxify"}).click();
			});
			return nRow;
		},
	...
	<div class="col-md-12">
		...
		<div class="portlet box purple">
			...
			<div class="portlet-body form util-btn-margin-bottom-5" style="margin-bottom: -15px">
				<div class="form-body">
					<div class="clearfix">
						<a data-href="{$this->basePath()}/pengiriman/permohonanplpkmsdetail/add?ID_PLP={$desc['ID_PLP']}" class="btn btn-circle purple ajaxify">
