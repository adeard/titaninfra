...
jQuery(document).ready(function() {	
	...
	var oPendukungplpTable 		= pendukungplpTable.dataTable({
		...
		"bDestroy": true,
		"ajax": {
			"url": base_url+"penerimaan/pendukungplp/json",
		},
		"columns": [
			...
			$.ajax({
				...
				success: function(data) {
					if(data.check_valid == "valid"){
						getListPendukungplp(data.NO_BC11, data.TGL_BC11, data.NO_CONT);
					} else {
		...
		<div class="portlet box green-haze">
			...
			<div class="portlet-body form">
				<div class="form-body">
					...
					<form 	action="{$this->basePath()}/penerimaan/pendukungplp/search" 
							method="post" 
                                ...
                                <div class="col-md-8">
									<div class="input-group input-medium date date-picker">
										<input 	type="text" 
												...
												data-rule-required="true"
                                        		data-msg-required="Silahkan isi TGL BC11"
			...
			<div class="portlet-body">
				<div class="table-container">
					<table 	cellpadding="0" 
							...
							id="pendukungplpTable">
					<thead>
					<tr role="row" class="heading">
                        <th class="table-checkbox"><input type="checkbox" class="group-checkable" data-set="#pendukungplpTable .checkboxes"/></th>
                        <th>ID</th>
                        <th>NO BC11</th> 
						<th>TGL BC11</th> 
						<th>NO CONT</th> 
