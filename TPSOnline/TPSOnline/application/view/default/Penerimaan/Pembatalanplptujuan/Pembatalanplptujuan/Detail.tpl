...
<!-- BEGIN PAGE CONTENT-->
<form 	action="{$this->basePath()}/penerimaan/pembatalanplptujuan/save" 
    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue-madison">
            <div class="portlet-title">
                ...
                <div class="actions">
                	<a data-href="{$this->basePath()}/penerimaan/pembatalanplptujuan/list" class="btn btn-default btn-sm ajaxify">
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">   
                           	<a data-href="{$this->basePath()}/penerimaan/pembatalanplptujuan/list" class="btn default ajaxify">
                            	<i class="fa fa-arrow-left"></i> Kembali 
                            </a>
                        </div>
                    </div>
