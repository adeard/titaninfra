...
<!-- BEGIN PAGE CONTENT-->
<form 	action="{$this->basePath()}/penerimaan/pembatalanplpasalkms/save" 
    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue-madison">
            <div class="portlet-title">
                ...
                <div class="actions">
                	<a data-href="{$this->basePath()}/penerimaan/pembatalanplpasalkms" class="btn btn-default btn-sm ajaxify">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-medium date date-picker">
                                	<input 	type="text" disabled
                                            name="TGL_BATAL_PLP"
                                            id="TGL_BATAL_PLP"
                                            value="{$desc['TGL_BATAL_PLP']|date_format:"%d/%m/%Y"}"
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                           	<a data-href="{$this->basePath()}/penerimaan/pembatalanplpasalkms" class="btn default ajaxify">
                            	<i class="fa fa-arrow-left"></i> Kembali 
                            </a>
                        </div>
                    </div>
