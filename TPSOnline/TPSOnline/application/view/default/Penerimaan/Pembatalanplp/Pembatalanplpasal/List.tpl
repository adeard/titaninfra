	...
	<div class="col-md-12">
		...
		<div class="portlet box green-haze">
			<div class="portlet-title">
				...
				<div class="actions">
					<a data-href="{$this->basePath()}/penerimaan/pembatalanplpasal" class="btn btn-default btn-sm ajaxify">
			...
			<div class="portlet-body form util-btn-margin-bottom-5" style="margin-bottom: -15px">
				<form 	action="{$this->basePath()}/penerimaan/pembatalanplpasal/send" 
						method="post" 
