...
<!-- BEGIN PAGE CONTENT-->
<form 	action="{$this->basePath()}/penerimaan/persetujuanplpasal/send" 
		method="post" 
	...
	<div class="col-md-12">
		...
		<div class="portlet box green-haze">
			<div class="portlet-title">
				...
				<div class="actions">
					<a data-href="{$this->basePath()}/penerimaan/persetujuanplpasal" class="btn btn-default btn-sm ajaxify">
