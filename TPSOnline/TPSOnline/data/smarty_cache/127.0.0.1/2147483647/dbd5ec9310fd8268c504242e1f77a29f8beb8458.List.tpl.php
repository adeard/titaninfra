<?php
/* Smarty version 3.1.30, created on 2017-05-19 14:53:17
  from "D:\WEBAPPS\Public_html\Development\TPSOnline\application\view\default\penerimaan\Pembatalanplp\Pembatalanplpasal\List.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_591ea46d4e2b19_18535013',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '740e5fcf1d522019e29997a7b51af44d4f2705c5' => 
    array (
      0 => 'D:\\WEBAPPS\\Public_html\\Development\\TPSOnline\\application\\view\\default\\penerimaan\\Pembatalanplp\\Pembatalanplpasal\\List.tpl',
      1 => 1484934061,
      2 => 'file',
    ),
  ),
...
function content_591ea46d4e2b19_18535013 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
<div class="page-bar">
    <ul class="page-breadcrumb">
                    ...
                    <i class="fa fa-angle-right"></i>
                                            	                ...
                                            	                <li class='active'>
                    <a href="javascript:void(0)">Pembatalan PLP TPS Asal Peti Kemas</a>
                </li>
                                        </ul>
</div>
...
jQuery(document).ready(function() {	
	...
	var oPembatalanplpTable 	= pembatalanplpTable.dataTable({
		...
		"bDestroy": true,
		"ajax": {
			"url": base_url+"penerimaan/pembatalanplpasal/json",
		},
		"columns": [
		...
		"fnRowCallback": function (nRow, aaData, iDisplayIndex, iDisplayIndexFull) {
			$(nRow).dblclick(function() {
				$(nRow).attr({"data-href":base_url+"penerimaan/pembatalanplpasal/detail/"+aaData[1], "class":"ajaxify"}).click();
			});
			return nRow;
		},
	...
	<div class="col-md-12">
		...
		<div class="portlet box green-haze">
			<div class="portlet-title">
				...
				<div class="actions">
					<a data-href="/penerimaan/pembatalanplpasal" class="btn btn-default btn-sm ajaxify">
			...
			<div class="portlet-body form util-btn-margin-bottom-5" style="margin-bottom: -15px">
				<form 	action="/penerimaan/pembatalanplpasal/send" 
						method="post" 
