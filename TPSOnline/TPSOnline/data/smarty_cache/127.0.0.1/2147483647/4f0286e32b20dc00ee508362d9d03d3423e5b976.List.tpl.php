<?php
/* Smarty version 3.1.30, created on 2017-01-15 22:44:39
...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_587b98e71fcdc3_68217207',
...
function content_587b98e71fcdc3_68217207 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
<div class="page-bar">
    <ul class="page-breadcrumb">
                    ...
                    <i class="fa fa-angle-right"></i>
                                                ...
                                                <li>
                                        <a data-href="/pengiriman/pembatalanplp" class="ajaxify">Pembatalan PLP</a>
                    <i class="fa fa-angle-right"></i>
                                    </li>
                                            	                <li class='active'>
                    <a href="javascript:void(0)">Pembatalan PLP Peti Kemas</a>
                </li>
                                        </ul>
</div>
	...
	<div class="col-md-12">
		...
		<div class="portlet box green-haze">
			<div class="portlet-title">
				...
				<div class="actions">
					<a data-href="/pengiriman/pembatalanplp" class="btn btn-default btn-sm ajaxify">
			...
			<div class="portlet-body form util-btn-margin-bottom-5" style="margin-bottom: -15px">
				<form 	action="/pengiriman/pembatalanplp/send" 
						method="post" 
						class="SendAll form-horizontal">
						
				<div class="form-body">
					<div class="clearfix">
						<a data-href="/pengiriman/pembatalanplp/add" class="btn btn-circle blue ajaxify">
