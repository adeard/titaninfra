<?php
/* Smarty version 3.1.30, created on 2017-05-19 14:52:37
  from "D:\WEBAPPS\Public_html\Development\TPSOnline\application\view\default\Pengiriman\Kemasan\Kemasan\List.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_591ea445e3b9c6_73454136',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd7e85c128ae391c201d8c958f71e82a6bb77d920' => 
    array (
      0 => 'D:\\WEBAPPS\\Public_html\\Development\\TPSOnline\\application\\view\\default\\Pengiriman\\Kemasan\\Kemasan\\List.tpl',
      1 => 1483431603,
      2 => 'file',
    ),
  ),
...
function content_591ea445e3b9c6_73454136 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
<div class="page-bar">
    <ul class="page-breadcrumb">
                    ...
                    <i class="fa fa-angle-right"></i>
                                            	                ...
                                            	                <li class='active'>
                    <a href="javascript:void(0)">Coarri-Codeco Kemasan</a>
                </li>
                                        </ul>
</div>
...
jQuery(document).ready(function() {	
	...
	var oKemasanTable 		= kemasanTable.dataTable({
		...
		"bDestroy": true,
		"ajax": {
			"url": base_url+"pengiriman/kemasan/json",
		},
		"columns": [
		...
		"fnRowCallback": function (nRow, aaData, iDisplayIndex, iDisplayIndexFull) {
			$(nRow).dblclick(function() {
				$(nRow).attr({"data-href":base_url+"pengiriman/kemasan/edit/"+aaData[1], "class":"ajaxify"}).click();
			});
			return nRow;
		},
		...
		$.ajax({
			...
			success: function(data) {
				if(data.check_valid == "valid"){
					getListKemasan(data.REF_NUMBER, data.TGL_TIBA);
				} else {
		...
		<div class="portlet box green-haze">
			...
			<div class="portlet-body form">
				<div class="form-body">
					...
					<form 	action="/pengiriman/kemasan/search" 
							method="post" 
			...
			<div class="portlet-body form util-btn-margin-bottom-5" style="margin-bottom: -15px">
				<form 	action="/pengiriman/kemasan/send" 
						method="post" 
				...
				<div class="form-body">
					...
					<div class="clearfix">
						<a data-href="/pengiriman/kemasan/add" class="btn btn-circle blue ajaxify">
			...
			<div class="portlet-body">
				<div class="table-container">
					...
					<tr role="row" class="heading">
                        <th class="table-checkbox"><input type="checkbox" class="group-checkable" data-set="#kemasanTable .checkboxes"/></th>
                        <th>ID</th>
                        <th>REF NUMBER</th>
						<th>NM DOK</th>
						<th>KD TPS</th>
