<?php
/* Smarty version 3.1.30, created on 2017-05-19 14:53:11
  from "D:\WEBAPPS\Public_html\Development\TPSOnline\application\view\default\penerimaan\Persetujuanplptujuan\Persetujuanplptujuan\List.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_591ea467de1c81_99669524',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '51881371e172bb83520b12bb16371e3d0426fd14' => 
    array (
      0 => 'D:\\WEBAPPS\\Public_html\\Development\\TPSOnline\\application\\view\\default\\penerimaan\\Persetujuanplptujuan\\Persetujuanplptujuan\\List.tpl',
      1 => 1484494331,
      2 => 'file',
    ),
  ),
...
function content_591ea467de1c81_99669524 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
<div class="page-bar">
    <ul class="page-breadcrumb">
                    ...
                    <i class="fa fa-angle-right"></i>
                                            	                ...
                                            	                <li class='active'>
                    <a href="javascript:void(0)">Respon PLP TPS Tujuan Peti Kemas</a>
                </li>
                                        </ul>
</div>
...
jQuery(document).ready(function() {	
	...
	var oPermohonanplpTable 	= permohonanplpTable.dataTable({
		...
		"bDestroy": true,
		"ajax": {
			"url": base_url+"penerimaan/persetujuanplptujuan/json",
		},
		"columns": [
		...
		"fnRowCallback": function (nRow, aaData, iDisplayIndex, iDisplayIndexFull) {
			$(nRow).dblclick(function() {
				$(nRow).attr({"data-href":base_url+"penerimaan/persetujuanplptujuan/detail/"+aaData[1], "class":"ajaxify"}).click();
			});
			return nRow;
		},
...
<!-- BEGIN PAGE CONTENT-->
<form 	action="/penerimaan/persetujuanplptujuan/send" 
		method="post" 
	...
	<div class="col-md-12">
		...
		<div class="portlet box green-haze">
			<div class="portlet-title">
				...
				<div class="actions">
					<a data-href="/penerimaan/persetujuanplptujuan" class="btn btn-default btn-sm ajaxify">
