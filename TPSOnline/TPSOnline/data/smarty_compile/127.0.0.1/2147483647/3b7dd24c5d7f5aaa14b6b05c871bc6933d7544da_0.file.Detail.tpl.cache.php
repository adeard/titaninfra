<?php
/* Smarty version 3.1.30, created on 2017-01-22 23:23:35
  from "D:\WEBAPPS\Public_html\Development\TPSOnline\application\view\default\penerimaan\Pembatalanplptujuan\Pembatalanplptujuankms\Detail.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5884dc8768c632_44595171',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3b7dd24c5d7f5aaa14b6b05c871bc6933d7544da' => 
    array (
      0 => 'D:\\WEBAPPS\\Public_html\\Development\\TPSOnline\\application\\view\\default\\penerimaan\\Pembatalanplptujuan\\Pembatalanplptujuankms\\Detail.tpl',
      1 => 1485101968,
      2 => 'file',
    ),
  ),
...
function content_5884dc8768c632_44595171 (Smarty_Internal_Template $_smarty_tpl) {
if (!is_callable('smarty_modifier_date_format')) require_once 'D:\\SYSTEM\\Vendor\\Smarty\\libs\\plugins\\modifier.date_format.php';
$_smarty_tpl->compiled->nocache_hash = '174305884dc8762ed65_88346960';
?>
...
";
	var pembatalanplpkmsdetailTable	= $('#pembatalanplpkmsdetailTable');
	var oPembatalanplpkmsdetailTable= pembatalanplpkmsdetailTable.dataTable({
		...
		"bFilter": false,
		"ajax": {
			"url": base_url+"penerimaan/pembatalanplptujuankmsdetail/json?ID_RESPONPLP="+ID_RESPONPLP,
		},
		"columns": [
...
/penerimaan/pembatalanplptujuankms/save" 
...
/penerimaan/pembatalanplptujuankms" class="btn btn-default btn-sm ajaxify">
...
"
                            ...
                            <div class="form-group">
                                ...
                                <input 	type="text" disabled
                                        value="<?php echo $_smarty_tpl->tpl_vars['desc']->value['KD_TPS_ASAL'];?>
"
                                        disable
...
"
                            ...
                            <div class="form-group">
                                <label class="control-label">
                                    NO BATAL PLP <span class="required">&nbsp;</span>
                                </label>
                                <input 	type="text" disabled
                                        value="<?php echo $_smarty_tpl->tpl_vars['desc']->value['NO_BATAL_PLP'];?>
"
                                        
                                        placeholder="NO BATAL PLP"
                            ...
                            <div class="form-group">
                                <label class="control-label">
                                    TGL BATAL PLP <span class="required">&nbsp;</span>
                                </label>
                                <div class="input-group input-medium date date-picker">
                                	<input 	type="text" disabled
                                            name="TGL_BATAL_PLP"
                                            id="TGL_BATAL_PLP"
                                            value="<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['desc']->value['TGL_BATAL_PLP'],"%d/%m/%Y");?>
"
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                           	<a data-href="<?php echo $_smarty_tpl->tpl_vars['this']->value->basePath();?>
/penerimaan/pembatalanplptujuankms" class="btn default ajaxify">
                            	<i class="fa fa-arrow-left"></i> Kembali 
                            </a>
                        </div>
                    </div>
			...
			<div class="portlet-body">
				<div class="table-container">
					<table 	cellpadding="0" 
							...
							id="pembatalanplpkmsdetailTable">
					<thead>
