...
var Layout = function () {
    ...
    var handleSidebarAndContentHeight = function () {
		...
		if(Metronic.getViewPort().width < 487)
		{
			$('.tiles .tile.singgle').addClass('double');
		}else{
			$('.tiles .tile.singgle').removeClass('double');
		}
		
		if(Metronic.getViewPort().width > 991)
		{
			$('.page-bar.page-bar-logo').show();
		}else{
			$('.page-bar.page-bar-logo').hide();
		}
    };
    ...
    var handleSidebarMenu = function () {
        ...
        $('.page-header').on('click', '.ajaxify', function (e) {
            e.preventDefault();
            Metronic.scrollTop();
